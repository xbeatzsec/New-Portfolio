...
$(function(){
      ...
      "<span style='color:#009966;'><pre>put something</pre>",

"<span style='color:#009966;'><pre>Nani, 21 yo, Pentester</pre>",

      "<span style='color:#009966;'><pre>Type: \"nani\" and you see magic</pre>",
          "<span style='color:#009966;'><pre>+---[RSA 4096]----+<br>|#E*....          |<br>|%#++n .           |<br>|@*O.=a            |<br>|O*.B . .n        |<br>|*o. o . S-i       |<br>|oo . . .         |<br>|o .   .          |<br>|.                |<br>|                 |<br>+----[SHA256]-----+<br></pre>"
      ],
      contentType: 'html',
      typeSpeed: 0,
      loop: true,
